...
>
> **🎓 MoAI-ADK 마스터 클래스**:
> 에이전틱 워크플로우를 마스터하려면 **[강의 시리즈](./lecture/ROADMAP.KR.md)**를 확인하세요.
> 아키텍처부터 코틀린 바이브 코딩까지 상세한 커리큘럼이 준비되어 있습니다.
>
> **🌐 강의 웹사이트**: 브라우저에서 `lecture/site/ROADMAP.KR.html`을 열어 최적의 경험을 즐기세요.
